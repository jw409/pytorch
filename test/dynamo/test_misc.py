...
""",
    ...
    def test_aot_capture(self):
        ...
        compiled_foo = torch._dynamo.eval_frame.aot_capture(foo)
        compiled_foo(torch.randn(3, 2))
        compiled_foo(torch.randn(4))
        artifacts = compiled_foo.get_artifacts()

        guarded_codes = artifacts.dynamo_artifacts.codes[0].guarded_codes
        ...
        guards0, ep0 = _convert_to_ep_demo(guarded_codes[0], backend_ids[0], gms[0], (torch.randn(3, 2),))
