...
def aot_capture(model):
    ...
    The CaptureArtifacts is separated into two parts:
    ...
    capture_context.get_artifacts = lambda: CaptureArtifacts(dynamo_artifacts=package.cache_entry(), backend_inputs=backend_inputs)
